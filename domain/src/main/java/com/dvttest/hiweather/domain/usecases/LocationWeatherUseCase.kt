...
typealias LocationWeatherBaseUseCase = BaseUseCase<UserLocation, Flow<State<Weather?>>>

class LocationWeatherUseCase @Inject constructor(
    private val weatherRepository: WeatherRepository
) : LocationWeatherBaseUseCase {

    override suspend fun invoke(params: UserLocation) = weatherRepository.getCurrentLocationWeather(params)
}
