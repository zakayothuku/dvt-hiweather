...
typealias UpdateLocationBaseUseCase = BaseUseCase<Favorite, Any>

class UpdateLocationUseCase @Inject constructor(
    private val favoritesRepository: FavoritesRepository
) : UpdateLocationBaseUseCase {

    override suspend fun invoke(params: Favorite) = favoritesRepository.updateLocation(params)
}
