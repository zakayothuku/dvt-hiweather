...
object DatabaseModule {
    ...
    @Singleton
    @Provides
    fun provideDatabase(@ApplicationContext context: Context): HiWeatherDatabase {
        return Room.databaseBuilder(context, HiWeatherDatabase::class.java, "hi_weather.db").build()
    }
